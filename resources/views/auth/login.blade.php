<x-guest-layout>
    ...
    <style>
        ...
        /* Kita targetkan body dan elemen pembungkus utama */
        body, .min-h-screen {
        ...
        /* Menghilangkan warna background bawaan yang mungkin menutupi gambar */
        div[class*="bg-slate-"], div[class*="bg-gray-"], main {
            background-color: transparent !important;
        }

        /* Kembalikan warna gelap hanya untuk KOTAK LOGIN saja */
        .login-card {
            background-color: rgba(15, 23, 42, 0.7) !important; /* Slate-900 dengan transparansi */
        ...
        <div class="login-card w-full sm:max-w-md px-8 py-12 border border-white/10 shadow-2xl rounded-3xl">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <p class="mt-8 text-center text-xs text-gray-500">
                    Belum punya akses? <a href="#" class="text-blue-400 font-bold hover:underline">Hubungi Admin</a>
                </p>
            </form>
        </div>
    </div>
